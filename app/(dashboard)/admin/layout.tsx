            ...
            <div className="flex min-h-screen bg-gray-50">
                ...
                <aside className="fixed inset-y-0 left-0 z-50 w-64 bg-white border-r border-gray-200 pb-10 pt-5 transition-transform flex flex-col">
                    ...
                    <div className="mt-auto px-4 pt-4 border-t border-gray-100">
                        ...
                        <Link
                            href="/pos"
                            className="flex w-full items-center justify-center gap-2 mt-2 px-3 py-2 rounded-lg text-sm font-medium text-indigo-600 bg-indigo-50 hover:bg-indigo-100 transition-colors"
                        >
                            POS Terminali
                        </Link>
                    </div>
